            ...
            >
                ...
                <div className="bg-brand-surface p-3 rounded-lg shadow-sm flex items-center space-x-4">
                    ...
                    <span className="relative inline-flex ml-2">
                        ...
                        <div role="tooltip" className="absolute left-full top-1/2 -translate-y-1/2 ml-2 w-72 bg-gray-100 text-gray-900 text-[0.95rem] p-2.5 rounded shadow border border-gray-200 hidden group-hover:block z-10">
