            ...
            <div className="max-w-full mx-auto flex items-center space-x-3">
                ...
                <div className="flex items-center space-x-2">
                    ...
                    <button
                        ...
                        className="relative group py-2 px-3 bg-red-600 dark:bg-red-600 text-white rounded-md hover:bg-red-700 dark:hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center font-semibold text-base"
                        style={{
